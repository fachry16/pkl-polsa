...
Route::middleware(['auth'])->prefix('kelas')->name('lms.')->group(function () {
    ...
    Route::get('/{pengampu}/forum/{diskusi}/file', [LmsForumController::class, 'file'])->name('forum.file');

    Route::get('/{pengampu}/rekap-nilai', [LmsTugasController::class, 'rekap'])->name('tugas.rekap');
    Route::post('/{pengampu}/sync-nilai', [LmsTugasController::class, 'syncToRps'])->name('tugas.sync');
});
