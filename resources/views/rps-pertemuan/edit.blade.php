    ...
    <div class="form-group">
        ...
        @if($pertemuan->file_materi)
            <div style="font-size: 0.75rem; color: #16a34a; margin-top: 0.25rem;">
                File saat ini: <a href="{{ route('rps.pertemuan.file', [$rps->id, $pertemuan->id]) }}" target="_blank" style="text-decoration: underline;">{{ $pertemuan->file_materi_nama ?: 'Unduh Materi' }}</a>
            </div>
        @else
