...
<div style="max-width: 900px; margin: 0 auto;">
    ...
    <div style="margin-bottom: 1rem;">
        <a href="{{ route('mahasiswa.lms.show', $pengampu->id) }}?tab=materi" class="btn btn-secondary btn-sm" style="display: inline-flex; align-items: center; gap: 0.4rem;">
            ...
            <div style="flex: 1;">
                <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 0.5rem;">
                    ...
                    <form action="{{ route('mahasiswa.lms.materi.selesai', $materi->id) }}" method="POST" style="margin: 0;">
                        @csrf
                        <button type="submit" class="btn {{ $isSelesai ? 'btn-secondary' : 'btn-primary' }} btn-sm" style="display: inline-flex; align-items: center; gap: 0.4rem;">
                            @if($isSelesai)
                                ...
                                <span style="color: #059669; font-weight: 600;">Selesai Dibaca</span>
                            @else
