...
<div class="flex-header">
    <h1 class="page-header" style="margin: 0;">Cetak KHS Mahasiswa</h1>
...
<div style="max-width: 560px;">
    <div class="card">
        <h3 style="margin: 0 0 1rem; font-size: 1rem; font-weight: 600;">Pilih Mahasiswa &amp; Semester KHS</h3>

        <p style="font-size: 0.8rem; color: #6b7280; margin: 0 0 1rem;">
            Pilih program studi, tahun akademik, lalu mahasiswa untuk mencetak Kartu Hasil Studi (KHS) lengkap dengan nilai huruf, bobot mutu, dan Indeks Prestasi Semester (IPS).
        </p>

        <form action="{{ route('khs.pilih-mahasiswa') }}" method="POST" id="formCetak">
            @csrf
