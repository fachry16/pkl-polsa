    ...
    <form action="{{ route('users.store') }}"
        ...
        <div style="background-color: #FFF8E0; border: 1px solid #FFE88F; border-radius: 8px; padding: 0.85rem 1rem; margin-bottom: 1.25rem; display: flex; align-items: flex-start; gap: 0.75rem;">
            ...
            <div style="font-size: 0.85rem; color: #B8860B; line-height: 1.4;">
                ...
                Manajemen User digunakan untuk membuat akun Administrator. Untuk membuat akun <strong>Dosen, Kaprodi, Direktur, atau Mahasiswa</strong>, silakan gunakan menu <a href="{{ route('dosen.index') }}" style="color: #A16207; font-weight: 600; text-decoration: underline;">Master Data Dosen</a> atau <a href="{{ route('mahasiswa.index') }}" style="color: #A16207; font-weight: 600; text-decoration: underline;">Master Data Mahasiswa</a> agar NIDN/NIM terdaftar dengan lengkap.
            </div>
        </div>
