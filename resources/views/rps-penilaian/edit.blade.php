...
<form action="{{ route('rps.penilaian.update', $rps) }}"
    ...
    <div class="form-group">
        ...
        <p id="total-penilaian" class="text-lg font-bold">
            {{ old('tugas', $penilaian->tugas) + old('quiz', $penilaian->quiz) + old('uts', $penilaian->uts) + old('uas', $penilaian->uas) + old('praktikum', $penilaian->praktikum) + old('project', $penilaian->project) + old('absensi', $penilaian->absensi) + old('keaktifan', $penilaian->keaktifan) + old('etika', $penilaian->etika) }}%
        </p>
