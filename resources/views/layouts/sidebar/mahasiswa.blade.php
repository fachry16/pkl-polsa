<aside class="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="{{ route('mahasiswa.lms.index') }}" class="{{ request()->routeIs('mahasiswa.lms.*') ? 'active' : '' }}" title="Kelas LMS Saya" data-title="Kelas LMS Saya"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 19.5A2.5 2.5 0 016.5 17H20"/><path d="M6.5 2H20v20H6.5A2.5 2.5 0 014 19.5v-15A2.5 2.5 0 016.5 2z"/></svg><span class="nav-text">Kelas LMS Saya</span></a>
    </nav>
</aside>
