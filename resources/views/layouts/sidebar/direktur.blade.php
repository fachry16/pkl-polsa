<aside class="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        @if(auth()->user()->isDosen())
            <a href="{{ route('dosen.self') }}" class="{{ request()->routeIs('dosen.self') ? 'active' : '' }}"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 21v-2a4 4 0 00-4-4H8a4 4 0 00-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>Data Diri Dosen</a>
            @if(auth()->user()->dosen)
