<aside class="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="{{ route('monitoring.kurikulum') }}" class="{{ request()->routeIs('monitoring.kurikulum') ? 'active' : '' }}" title="Kurikulum" data-title="Kurikulum"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 10v6M2 10l10-5 10 5-10 5z"/><path d="M6 12v5c3 3 9 3 12 0v-5"/></svg><span class="nav-text">Kurikulum</span></a>
        @php
