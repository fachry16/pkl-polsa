<aside class="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        @if(auth()->user()->isKaprodi())
            ...
            @endif
            <a href="{{ route('rps.pengajuan') }}" class="{{ request()->routeIs('rps.pengajuan') ? 'active' : '' }}" title="Pengajuan RPS" data-title="Pengajuan RPS"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><polyline points="10 9 9 9 8 9"/></svg><span class="nav-text">Pengajuan RPS</span></a>
        ...
        @if(auth()->user()->isDosen())
            <a href="{{ route('dosen.self') }}" class="{{ request()->routeIs('dosen.self') ? 'active' : '' }}" title="Data Diri Dosen" data-title="Data Diri Dosen"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 21v-2a4 4 0 00-4-4H8a4 4 0 00-4 4v2"/><circle cx="12" cy="7" r="4"/></svg><span class="nav-text">Data Diri Dosen</span></a>
            @if(auth()->user()->dosen)
                <a href="{{ route('dosen.self.riwayat') }}" class="{{ request()->routeIs('dosen.self.riwayat') ? 'active' : '' }}" title="Riwayat Mengajar &amp; RPS" data-title="Riwayat Mengajar &amp; RPS"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/></svg><span class="nav-text">Riwayat Mengajar &amp; RPS</span></a>
            @endif
            <a href="{{ route('lms.index') }}" class="{{ request()->routeIs('lms.*') ? 'active' : '' }}" title="Kelas LMS Saya" data-title="Kelas LMS Saya"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 19.5A2.5 2.5 0 016.5 17H20"/><path d="M6.5 2H20v20H6.5A2.5 2.5 0 014 19.5v-15A2.5 2.5 0 016.5 2z"/></svg><span class="nav-text">Kelas LMS Saya</span></a>
        @endif
    </nav>
</aside>
