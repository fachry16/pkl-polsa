            ...
            @forelse($recentNotifications as $notification)
                ...
                <a href="{{ route('notifications.read', $notification->id) }}"
                   ...
                   onmouseout="this.style.background='{{ $notification->unread() ? '#f8fafc' : '#ffffff' }}';">
                    ...
                    @if($type === 'MateriBaru')
                        <div style="width: 2.2rem; height: 2.2rem; border-radius: 8px; background: #FFF8E0; color: #A16207; display: flex; align-items: center; justify-content: center; flex-shrink: 0;">
                    ...
                    @elseif($type === 'DrafTugasRpsBaru')
                        <div style="width: 2.2rem; height: 2.2rem; border-radius: 8px; background: #fef3c7; color: #b45309; display: flex; align-items: center; justify-content: center; flex-shrink: 0;">
                    ...
                    @elseif($type === 'PengumumanBaru')
                        <div style="width: 2.2rem; height: 2.2rem; border-radius: 8px; background: #faf5ff; color: #A16207; display: flex; align-items: center; justify-content: center; flex-shrink: 0;">
                    ...
                    @elseif($type === 'ForumDiskusiBaru')
                        <div style="width: 2.2rem; height: 2.2rem; border-radius: 8px; background: #FFFBE9; color: #A16207; display: flex; align-items: center; justify-content: center; flex-shrink: 0;">
                    ...
                    @elseif($type === 'NilaiDiajukan')
                        <div style="width: 2.2rem; height: 2.2rem; border-radius: 8px; background: #fffbeb; color: #d97706; display: flex; align-items: center; justify-content: center; flex-shrink: 0;">
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M10.29 3.86L1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z"/><line x1="12" y1="9" x2="12" y2="13"/><line x1="12" y1="17" x2="12.01" y2="17"/></svg>
                        </div>
                    @elseif($type === 'NilaiDisetujui')
                        <div style="width: 2.2rem; height: 2.2rem; border-radius: 8px; background: #ecfdf5; color: #059669; display: flex; align-items: center; justify-content: center; flex-shrink: 0;">
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg>
                        </div>
                    @elseif($type === 'NilaiDirevisi')
                        <div style="width: 2.2rem; height: 2.2rem; border-radius: 8px; background: #fff1f2; color: #e11d48; display: flex; align-items: center; justify-content: center; flex-shrink: 0;">
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg>
                        </div>
                    @else
                        <div style="width: 2.2rem; height: 2.2rem; border-radius: 8px; background: #FFF3C4; color: #A16207; display: flex; align-items: center; justify-content: center; flex-shrink: 0;">
                    ...
                    <div style="flex: 1; min-width: 0;">
                        <div style="display: flex; align-items: center; justify-content: space-between; gap: 0.5rem;">
                            ...
                            @if($notification->unread())
                                <span style="width: 7px; height: 7px; border-radius: 50%; background: #FEC200; flex-shrink: 0;"></span>
                            @endif
                        </div>
