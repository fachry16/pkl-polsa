...
<div class="card">
    <form action="{{ route('program-studi.store') }}" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" name="kode_prodi" value="{{ old('kode_prodi') }}" class="form-input" placeholder="Contoh: 11" inputmode="numeric" pattern="[0-9]*" oninput="this.value=this.value.replace(/\D/g,'')">
            @error('kode_prodi')
